    ...
    return (
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mx-auto">
			...
			<div className="flex justify-center space-x-4">
				...
				<button onClick={LoginWGoogle} aria-label="Log in with Google" className="p-3 rounded-sm">
				...
				<button onClick={loginWGithub} aria-label="Log in with GitHub" className="p-3 rounded-sm">
